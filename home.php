...
<div class="mb">
  <ul class="tab">
    <li id="tab1" class="tt">健康新知</li>
    <li id="tab2" class="tt">菸害防治</li>
    <li id="tab3" class="tt">癌症防治</li>
    <li id="tab4" class="tt">慢性病防治</li>
  </ul>
  <div class="txt" id="p1"><h2>健康新知</h2>
  <pre>
...
7. 減少看電視、打電玩等靜態生活的時間。
  ...
  <div class="txt" id="p2"><h2>菸害防治</h2>
  <pre>
  菸害防治法規
...
第三十三條　　本法所定罰則，除第二十五條規定由中央主管機關處罰外，由直轄市、縣（市）主管機關處罰之。
  ...
  <div class="txt" id="p3"><h2>癌症防治</h2>
  <pre>
  降低罹癌風險 建構健康生活型態
...
上稿日期：2010/1/20
  ...
  <div class="txt" id="p4"><h2>慢性病防治</h2>
  <pre>
  長期憋尿 泌尿系統問題多 
資料來源：中央健康保險局雙月刊第98期
上稿日期：2012/08/10
...
<script>
//預設第一個頁籤及文章顯示
$("#tab1").css({"background":"#fff","border-bottom-color":"#fff"})
$("#p1").show();
...
$(".tt").on("click",function(){
  ...
  //取得被點擊的頁籤內的id值
  let id=$(this).attr('id').substr(3,1)
  
  //先將所有的頁籤容器的背景及底線的css做改變
  $(".tt").css({"background":"#ddd","border-bottom-color":"#999"});

  //再將被點擊的頁籤容器的背景及底線的CSS變色
  $(this).css({"background":"#fff","border-bottom-color":"#fff"})
